  ...
  steps: [
    ...
    },
    {
      ...
      fields: [
        ...
        { name: "experience", label: "Experience", type: "number", required: true},
      ],
    },  
  ],
};
  ...
  steps: [
    {
      ...
      fields: [
        ...
        { name: "hospitalNumber", label: "Hospital Number", type: "number", required: false, },
      ],
    },
    {
      stepName: "Additional Info",
      fields: [
        { name: "bedSize", label: "Hospital Bed Size", type: "text", required: false },
        { name: "departments", label: "Departments", type: "text", required: true},
        { name: "numberOfDoctors", label: "Number of Doctors", type: "number", required: true},
      ],
    },
  ],
};
